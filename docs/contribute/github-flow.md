<!-- Space: Projects -->
<!-- Parent: ZshStarship -->
<!-- Title: Contributing GithubFlow ZshStarship -->
<!-- Label: ZshStarship -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-starship project on [GitHub](https://github.com/hadenlabs/zsh-starship), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-starship/pulls).
...
To follow the instructions in this guide and start contributing to zsh-starship project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-starship.git
```

Now your **upstream** points to **hadenlabs/zsh-starship**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-starship
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-starship/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
